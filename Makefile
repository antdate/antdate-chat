# 配置
service_name = antdate-service
repository = registry.cn-beijing.aliyuncs.com/antdate/antdate-service
...
run: ##@run 启动服务.
	@echo "启动服务..."
	go run ./server -config=${PWD}/server/tinode.conf -static_data=""
